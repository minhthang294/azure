...
DIE("QUERY FAILED". pg_errormessage($connection));
}
...
echo "<div class='center-align meh'>
  ...
  if($user_role == 'admin'){
    ...
    echo "<meta http-equiv='refresh' content='0;url=http://localhost/Smartshop-master%20(1)/Smartshop-master/admin/index.php' />";
  }
